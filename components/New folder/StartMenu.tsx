        ...
        <div className="px-3 pb-2">
          <div className="border-t border-white/10 pt-2">
            <details className="group">
              <summary className="flex items-center justify-between px-4 py-2 hover:bg-white/10 cursor-pointer transition-all duration-300 rounded-xl list-none w-[180px]">
              ...
              <div className="bg-gradient-to-br from-amber-950/98 to-stone-900/98 backdrop-blur-xl rounded-xl w-[180px] p-1 shadow-xl border border-amber-900/30">
