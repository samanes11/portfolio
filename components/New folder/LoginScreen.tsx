        ...
        <div className="relative z-10 flex flex-col items-center gap-8 w-full max-w-md px-6 text-center animate-fadeUp">
          ...
          <div className="relative mx-auto">
            <div className="relative w-36 h-36 rounded-full p-[3px]">
              <div
                className="absolute inset-0 rounded-full animate-spinSlow opacity-70"
                style={{
                  background:
          ...
          <div className="w-full flex flex-col items-center gap-4">
            <button
              className="relative overflow-hidden flex items-center justify-center gap-2 w-1/2 py-3 px-6 bg-gradient-to-r from-amber-700 to-amber-600 text-white rounded-xl shadow-lg transition-all duration-300 active:scale-[.98] hover:shadow-amber-500/30"
              onClick={onLogin}
            >
            ...
            <button
              className="relative overflow-hidden flex items-center justify-center gap-2 w-1/2 py-3 px-6 bg-gradient-to-r from-red-500 to-orange-600 text-white font-semibold rounded-xl shadow-lg transition-all duration-300 active:scale-[.98]"
          ...
          <span className="text-gray-400 px-4 text-center" style={{ fontSize: 11 }}>
            For the best experience, please use a PC and press (F11) to enter full screen
          </span>
        </div>
      </div>
        ...
        <>
          ...
          <div className="fixed inset-0 z-[1001] flex items-center justify-center">
            ...
            >
              ...
              <div className="p-5 flex flex-col items-center gap-5" style={{ direction: "ltr" }}>
                <div className="w-full flex flex-col gap-1">
                  <label className="text-white/70 text-xs font-mono mb-1">Password</label>
                  <input
                    type="password"
                    value={password}
                    ...
                    style={{
                      background: "linear-gradient(135deg, rgba(134,137,143,0.4), rgba(35,29,49,0.4))",
                      color: "white",
                      fontWeight: 1000,
                      fontSize: 13,
                    }}
