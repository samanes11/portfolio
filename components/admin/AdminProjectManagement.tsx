    ...
    <>
          ...
          <div className="flex flex-row items-center flex-wrap sm:flex-nowrap gap-3 px-3 sm:px-6 py-3 sm:py-4 bg-[#1e1e1e] border-b border-gray-700">
            <div className="flex flex-row items-start gap-2 sm:gap-3 flex-1 min-w-0">
              ...
              <div className="flex flex-col min-w-0">
                <span
                  className="text-white font-bold tracking-wide text-sm sm:text-lg truncate"
                  style={{ fontSize: 18 }}
                >
                  Project Management
                </span>
                  ...
                  >
                    <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-5">
                        ...
                        <div className="flex flex-col flex-1 min-w-0 gap-1">
                          ...
                          <div className="flex flex-row flex-wrap gap-1 sm:gap-2">
                            {[
                              ...
                              <span
                                key={tag}
                                className="text-gray-400 bg-gray-700/50 px-1.5 sm:px-2 py-0.5 sm:py-1 rounded text-xs"
                              >
                                {tag}
                              </span>
                            ))}
                          ...
                          <span
                            className="text-gray-400 line-clamp-2 text-xs sm:text-sm"
                            style={{ fontSize: 13 }}
                          >
                            {project.desc}
                          </span>
                      ...
                      <div className="flex flex-row gap-2 flex-shrink-0 w-full sm:w-auto">
                        ...
                        >
                          <span className="icon-[mdi--pencil] w-3 h-3 sm:w-4 sm:h-4" />
                          Edit
                        </button>
                        <button
                        ...
                        >
                          <span className="icon-[mdi--delete] w-3 h-3 sm:w-4 sm:h-4" />
                          Delete
                        </button>
                      </div>
                    </div>
      ...
      {addModal && (
        <Modal title="Add New Project" onClose={() => setAddModal(false)}>
          ...
          <button
            onClick={handleAdd}
            className="w-full py-2 rounded-lg bg-green-600 hover:bg-green-500 text-white font-semibold mt-2 transition-colors"
          >
            Add Project
          </button>
        </Modal>
        ...
        <Modal title="Edit Project" onClose={() => setEditModal(null)}>
          <div className="flex flex-col gap-1 mb-3">
            ...
            <input
              value={editModal.id}
              disabled
              className="w-full rounded-lg px-3 py-2 text-sm bg-white/5 text-gray-500 border border-white/10 opacity-60"
            />
          </div>
          <FormFields
            data={editForm}
          ...
          <button
            onClick={handleEdit}
            className="w-full py-2 rounded-lg bg-blue-600 hover:bg-blue-500 text-white font-semibold mt-2 transition-colors"
          >
            Save Changes
          </button>
        </Modal>
      ...
      {deleteId && (
        ...
        >
          ...
          <button
            ...
            className="w-full py-2 rounded-lg bg-red-600 hover:bg-red-500 text-white font-semibold mt-2 transition-colors"
          >
            Delete
          </button>
        </Modal>
  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-[1001] flex items-center justify-center p-4">
        <div
          className="w-full rounded-2xl shadow-2xl border border-white/10 overflow-hidden"
          style={{
            maxWidth,
            background: "linear-gradient(135deg, #1E1E2C, #232838)",
          }}
        >
          ...
          <div className="p-5 flex flex-col gap-3" style={{ direction: "ltr" }}>
            {children}
          </div>
        </div>
      </div>
...
function Field({
  ...
  const base =
    "w-full rounded-lg px-3 py-2 text-sm bg-white/5 text-white border border-white/10 focus:border-blue-500/60 outline-none transition-colors";
  return (
