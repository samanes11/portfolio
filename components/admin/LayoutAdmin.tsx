...
export default function AdminLayoutManagement({
  onClose,
  onMinimize,
  onBack,
}: Props) {
            ...
            <div className="bg-gray-800/50 rounded-xl p-4 sm:p-6 border border-white/10 flex flex-col gap-5">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-2">
                ...
                <div className="flex flex-col gap-3">
                      ...
                      {desktopImages.map((img, i) => (
                        <div key={i} className="relative group">
                          ...
                          <img
                            src={img}
                            alt=""
                            className="w-20 h-14 rounded-lg object-cover border-2 border-gray-600"
                          />
                          <button
                            onClick={() =>
                              setDesktopImages((p) =>
                  ...
                  >
                    <span className="icon-[mdi--plus] w-4 h-4" /> Add Desktop
                    Image
                  </button>
                  <input
                    ref={desktopInputRef}
                ...
                <div className="flex flex-col gap-3">
                  ...
                  >
                    <span className="icon-[mdi--plus] w-4 h-4" /> Add Mobile
                    Image
                  </button>
                  <input
                    ref={mobileInputRef}
                ...
                <div className="bg-gray-800/50 rounded-xl p-4 sm:p-6 border border-white/10 flex flex-col gap-4">
                  ...
                  <div
                    ...
                    style={{
                      aspectRatio: "16/9",
                      background:
                        "linear-gradient(160deg, rgba(20,25,39,1), rgba(10,13,20,1))",
                    }}
                  >
                    {/* Glow */}
                    <div
                    ...
                    <div className="absolute top-5 left-5 right-5 z-10 flex justify-end">
                      <span className="text-2xl font-bold text-[#e9edf8]">
                        {projectName}
                      </span>
                    </div>
                    ...
                    {desktopImages.length > 0 && (
                      <div
                        style={{
                          ...
                          background:
                            "linear-gradient(to bottom, #e8eaed, #d5d8dc)",
                        }}
                      >
                        <div
                          style={{
                        ...
                        >
                          <div
                            style={{
                              ...
                              height: 4,
                              background:
                                "linear-gradient(90deg,transparent,#a8adb5 20%,#a8adb5 80%,transparent)",
                              borderRadius: 2,
                            }}
                          />
                          <div
                            style={{
                              ...
                              height: 20,
                              background:
                                "linear-gradient(to bottom,#c8ccd4,#9fa4ac)",
                        ...
                        {mobileImages.slice(0, 3).map((img, i) => (
                          <div
                            ...
                            style={{
                              width: 200,
                              background:
                                "linear-gradient(145deg,#1c1f2a,#12151e)",
                              borderRadius: 24,
                              padding: 4,
