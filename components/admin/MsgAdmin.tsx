      ...
      >
        <div className="flex flex-col gap-4" style={{ direction: "ltr" }}>
          {[
            ...
            <div key={label} className="flex flex-row items-start gap-2">
              <span
                className={`${icon} w-5 h-5 ${iconColor} flex-shrink-0 mt-0.5`}
              />
              <div className="flex flex-col flex-1">
                <span className="text-gray-100 font-extrabold text-xs mb-1">
                  {label}
                </span>
          ...
          <div className="flex flex-col gap-2 mt-1">
            <div className="flex flex-row items-center gap-2">
              ...
              <span className="text-gray-100 font-extrabold text-xs">
                Message
              </span>
            </div>
...
export default function AdminMessagesManagement({
  ...
  return (
    <>
                    ...
                    <div className="flex flex-row items-center gap-3 sm:gap-4 flex-1 min-w-0">
                      ...
                      <div className="flex flex-col flex-1 min-w-0 gap-1">
                        <div className="flex flex-row items-center flex-wrap gap-2">
                          ...
                          <span className="text-gray-400 bg-gray-700/50 px-2 py-0.5 rounded text-xs">
                            {message.Date}
                          </span>
                        </div>
                        ...
                        <span className="text-gray-400 text-xs sm:text-sm mt-1 line-clamp-2">
                          {message.msg}
                        </span>
                      </div>
                    </div>
      ...
      {modal === "view" && selected && (
        <ViewModal message={selected} onClose={() => setModal(null)} />
      )}
      {modal === "delete" && (
