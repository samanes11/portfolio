...
const sections: {
...
}[] = [
  {
    ...
    from: "from-blue-500/10",  to: "to-blue-600/10",
    iconColor: "from-blue-500 to-blue-600",
  },
  {
    id: "media", label: "Media Management",
    icon: "icon-[mdi--image-multiple]",
    from: "from-purple-500/10", to: "to-purple-600/10",
    iconColor: "from-purple-500 to-purple-600",
  },
  {
    id: "messages", label: "Messages",
    icon: "icon-[mdi--message-text]",
    from: "from-emerald-500/10", to: "to-emerald-600/10",
    iconColor: "from-emerald-500 to-emerald-600",
  },
  {
    id: "layout", label: "Poster Builder",
    icon: "icon-[mdi--image-frame]",
    from: "from-cyan-500/10", to: "to-cyan-600/10",
...
export default function ControlPanel({ onClose, onMinimize }: Props) {
  ...
  return (
    <WindowFloat
      ...
      maxWidth="120vh" title="Control Panel"
              ...
              >
                ...
                >
                  <div className="flex flex-col items-center gap-4 text-center">
                    <div className={`w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-br ${iconColor} rounded-2xl flex items-center justify-center shadow-lg`}>
                      <span className={`${icon} w-8 h-8 sm:w-10 sm:h-10 text-white`} />
                    </div>
